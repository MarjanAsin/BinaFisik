    ...
    <div class="mt-12">
        <div class="mb-6 flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-gray-600">
                    Pantau perkembangan hasil tes Anda dari waktu ke waktu
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h4 class="text-gray-900 font-bold mb-4">Progress Lari 12 Menit (meter)</h4>
                <canvas id="chartLari"></canvas>
            </div>

            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h4 class="text-gray-900 font-bold mb-4">Progress Push Up (repetisi)</h4>
                <canvas id="chartPushUp"></canvas>
            </div>

            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h4 class="text-gray-900 font-bold mb-4">Progress Sit Up (repetisi)</h4>
                <canvas id="chartSitUp"></canvas>
            </div>

            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h4 class="text-gray-900 font-bold mb-4">Progress Pull Up (repetisi)</h4>
